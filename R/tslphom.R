...
#'
#' @description  Estimates RxC (JxK) vote transfer matrices (ecological contingency tables) with tslphom
#'
...
#'                 in both iterations, including iteration zero (lphom) and final (including unit) solutions. 
...
#' @seealso \code{\link{lphom}} \code{\link{nslphom}} \code{\link{lclphom}} \code{\link{rslphom}}
#'
#' @examples
